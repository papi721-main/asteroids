...
from constants import ASTEROID_MIN_RADIUS, ASTEROID_SPLIT_RATE
...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        asteroid_1.velocity = vector_1 * ASTEROID_SPLIT_RATE

        asteroid_2 = Asteroid(self.position[0], self.position[1], new_radius)
        asteroid_2.velocity = vector_2 * ASTEROID_SPLIT_RATE
